...
- на странице 
    - загрузка ключей через API + загрузка ролей для диалога
    - привязка событий к ченжтрекеру
        - на диалог добавления, на клики по чекбоксу, на кнопку удаления  
        - поверка на дубли через TryAdd
        - конвертинг набора чекбоксов в флажки Permissions
    - ресет трекера при дискарде
    - сохранение данных и ресет трекера при сейве
